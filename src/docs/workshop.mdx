...
- `data-on-drag` takes a callback that returns a drag spec. The drag spec constructors come from `d`, which is provided as an argument to the draggable.
