...
// @ts-ignore
  ...
  var peg$e4 = peg$classExpectation([["A", "Z"], ["a", "z"], "_", "s", "(", ")", "#"], false, false);
...
// @ts-ignore
  ...
  var peg$f0 = function(x) {// @ts-ignore
 return Number(x) };
// @ts-ignore
  var peg$currPos = 0;
// @ts-ignore
...
export type ParseFunction = <Options extends ParseOptions>(
    ...
    StartRule extends "Pattern" ? Pattern : Pattern
    : Pattern;
...
export type Pattern = ["#" | null, _, PatternContents];
export type PatternContents = ["(", _, Op, _, Pattern[], _, ")"] | string;
export type Op = [string, Integer | null];
export type AnyChar = [string, string] | string;
